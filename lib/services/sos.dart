// ignore_for_file: prefer_const_constructors, deprecated_member_use, camel_case_types, prefer_const_constructors_in_immutables, avoid_function_literals_in_foreach_calls, avoid_print, prefer_final_fields
...
class _sosState extends State<sos> {
  ...
  var collection = FirebaseFirestore.instance.collection("SOS");
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        centerTitle: true,
        title: Text(AppLocalizations.of(context)!.sos,
            style: TextStyle(
              color: Colors.black,
            )),
          ...
          if (name.isEmpty || name == "Toute les regions")
            Align(
              ...
              child: Text(AppLocalizations.of(context)!
                  .counter(counter, AppLocalizations.of(context)!.sos)),
            ),
          Column(
            children: [
              isLoaded
