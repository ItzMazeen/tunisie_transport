// ignore_for_file: camel_case_types, prefer_const_constructors_in_immutables, prefer_const_constructors, deprecated_member_use, avoid_function_literals_in_foreach_calls, avoid_print, prefer_final_fields
...
class _motoState extends State<moto> {
  ...
  var collection = FirebaseFirestore.instance.collection("Moto");
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
          centerTitle: true,
          title: Text(AppLocalizations.of(context)!.moto,
              style: TextStyle(
                color: Colors.black,
              )),
          ...
          if (name.isEmpty || name == "Toute les regions")
            Align(
              ...
              child: Text(AppLocalizations.of(context)!
                  .counter(counter, AppLocalizations.of(context)!.moto)),
            ),
          Column(
            children: [
              isLoaded
