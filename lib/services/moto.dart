// ignore_for_file: camel_case_types, prefer_const_constructors_in_immutables, prefer_const_constructors, deprecated_member_use, avoid_function_literals_in_foreach_calls, avoid_print
...
class _motoState extends State<moto> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      drawer: NavBar(),
      appBar: AppBar(
          centerTitle: true, title: Text(AppLocalizations.of(context)!.moto)),
      body: ListView(
        children: [
          Padding(
