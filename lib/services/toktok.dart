// ignore_for_file: prefer_const_constructors, prefer_const_constructors_in_immutables, deprecated_member_use, avoid_function_literals_in_foreach_calls, avoid_print, prefer_final_fields
...
class _ToktokState extends State<Toktok> {
  ...
  var collection = FirebaseFirestore.instance.collection("TukTuk");
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
          centerTitle: true,
          title: Text(AppLocalizations.of(context)!.tuktuk,
              style: TextStyle(
                color: Colors.black,
              )),
          ...
          if (name.isEmpty || name == "Toute les regions")
            Align(
              ...
              child: Text(AppLocalizations.of(context)!
                  .counter(counter, AppLocalizations.of(context)!.tuktuk)),
            ),
          Column(
            children: [
              isLoaded
