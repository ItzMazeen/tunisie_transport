// ignore_for_file: prefer_const_constructors, prefer_const_constructors_in_immutables, deprecated_member_use, avoid_function_literals_in_foreach_calls, avoid_print
...
class _ToktokState extends State<Toktok> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      drawer: NavBar(),
      appBar: AppBar(
          centerTitle: true, title: Text(AppLocalizations.of(context)!.tuktuk)),
      body: ListView(
        children: [
          Padding(
