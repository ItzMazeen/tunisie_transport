// ignore_for_file: camel_case_types, prefer_const_constructors_in_immutables, prefer_const_constructors, avoid_function_literals_in_foreach_calls, deprecated_member_use, avoid_print
...
class _trucks_delState extends State<trucks_del> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      drawer: NavBar(),
      appBar: AppBar(
          centerTitle: true, title: Text(AppLocalizations.of(context)!.truck)),
      body: ListView(
        children: [
          Padding(
