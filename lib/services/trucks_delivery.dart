// ignore_for_file: camel_case_types, prefer_const_constructors_in_immutables, prefer_const_constructors, avoid_function_literals_in_foreach_calls, deprecated_member_use, avoid_print, prefer_final_fields
...
class trucks_del extends StatefulWidget {
  trucks_del({Key? key}) : super(key: key);

  @override
  State<trucks_del> createState() => _trucks_delState();
}

class _trucks_delState extends State<trucks_del> {
  ...
  var collection = FirebaseFirestore.instance.collection("Truck");
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
          centerTitle: true,
          title: Text(AppLocalizations.of(context)!.truck,
              style: TextStyle(
                color: Colors.black,
              )),
          ...
          if (name.isEmpty || name == "Toute les regions")
            Align(
              ...
              child: Text(AppLocalizations.of(context)!
                  .counter(counter, AppLocalizations.of(context)!.truck)),
            ),
          Column(
            children: [
              isLoaded
